...
// Picks up to 4 cards from a random eligible group (falling back to the
// whole deck if nothing's grouped yet) -- shared by Duel's challenge flow.
export function pickRoundCardIds(deck) {
